...
def recruitment_pipeline_card(request):
    ...
    return render(
        ...
        {"recruitment": recruitment_obj, "candidates": candidates, "stages": stages,"assigned_candidate_ids":assigned_candidate_ids},
    )
...
def candidate_search(request):
    ...
    return render(request, template, {"data": candidates, "pd": previous_data,"skills":SKILLS,"assigned_candidate_ids":assigned_candidate_ids})
