...
urlpatterns = [
    ...
    path("candidate_ranking/", views.candidate_ranking, name="candidate-ranking"),
    ...
    path("get_performace_rec", views.get_performace_rec, name="get_performace_rec",),
    path("get_matchscore_analysis", views.get_matchscore_analysis, name="get_matchscore_analysis",),
    path(
