...
env = environ.Env(
    ...
    ALLOWED_HOSTS=(list, ["*"]),
    CSRF_TRUSTED_ORIGINS=(list, ["http://localhost:8000",'http://20.163.23.152/','https://wholepersonhr.com','https://www.wholepersonhr.com']),
)
...
RESUME_ASSESSMENT_API_URL='http://127.0.0.1:5000/'
